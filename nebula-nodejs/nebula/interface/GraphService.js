...
GraphServiceClient.prototype.seqid = function () {
  return this._seqid;
};
GraphServiceClient.prototype.new_seqid = function () {
...
GraphServiceProcessor.prototype.process_authenticate = function (seqid, input, output) {
  ...
  if (this._handler.authenticate.length === 2) {
    Q.fcall(this._handler.authenticate.bind(this._handler), args.username, args.password).then(function (result) {
      const result_obj = new GraphService_authenticate_result({
        success: result
      });
    ...
    this._handler.authenticate(args.username, args.password, function (err, result) {
      ...
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_authenticate_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('authenticate', Thrift.MessageType.REPLY, seqid);
      } else {
...
GraphServiceProcessor.prototype.process_execute = function (seqid, input, output) {
  ...
  if (this._handler.execute.length === 2) {
    Q.fcall(this._handler.execute.bind(this._handler), args.sessionId, args.stmt).then(function (result) {
      const result_obj = new GraphService_execute_result({
        success: result
      });
    ...
    this._handler.execute(args.sessionId, args.stmt, function (err, result) {
      let result_obj;
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_execute_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('execute', Thrift.MessageType.REPLY, seqid);
      } else {
...
GraphServiceProcessor.prototype.process_executeWithParameter = function (seqid, input, output) {
  ...
  if (this._handler.executeWithParameter.length === 3) {
    Q.fcall(this._handler.executeWithParameter.bind(this._handler), args.sessionId, args.stmt, args.parameterMap).then(function (result) {
      const result_obj = new GraphService_executeWithParameter_result({
        success: result
      });
    ...
    this._handler.executeWithParameter(args.sessionId, args.stmt, args.parameterMap, function (err, result) {
      let result_obj;
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_executeWithParameter_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('executeWithParameter', Thrift.MessageType.REPLY, seqid);
      } else {
...
GraphServiceProcessor.prototype.process_executeJson = function (seqid, input, output) {
  ...
  if (this._handler.executeJson.length === 2) {
    Q.fcall(this._handler.executeJson.bind(this._handler), args.sessionId, args.stmt).then(function (result) {
      const result_obj = new GraphService_executeJson_result({
        success: result
      });
    ...
    this._handler.executeJson(args.sessionId, args.stmt, function (err, result) {
      let result_obj;
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_executeJson_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('executeJson', Thrift.MessageType.REPLY, seqid);
      } else {
...
GraphServiceProcessor.prototype.process_executeJsonWithParameter = function (seqid, input, output) {
  ...
  if (this._handler.executeJsonWithParameter.length === 3) {
    Q.fcall(this._handler.executeJsonWithParameter.bind(this._handler), args.sessionId, args.stmt, args.parameterMap).then(function (result) {
      const result_obj = new GraphService_executeJsonWithParameter_result({
        success: result
      });
    ...
    this._handler.executeJsonWithParameter(args.sessionId, args.stmt, args.parameterMap, function (err, result) {
      let result_obj;
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_executeJsonWithParameter_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('executeJsonWithParameter', Thrift.MessageType.REPLY, seqid);
      } else {
...
GraphServiceProcessor.prototype.process_verifyClientVersion = function (seqid, input, output) {
  ...
  if (this._handler.verifyClientVersion.length === 1) {
    Q.fcall(this._handler.verifyClientVersion.bind(this._handler), args.req).then(function (result) {
      const result_obj = new GraphService_verifyClientVersion_result({
        success: result
      });
    ...
    this._handler.verifyClientVersion(args.req, function (err, result) {
      let result_obj;
      if (err === null || typeof err === 'undefined') {
        result_obj = new GraphService_verifyClientVersion_result(err !== null || typeof err === 'undefined' ? err : {
          success: result
        });
        output.writeMessageBegin('verifyClientVersion', Thrift.MessageType.REPLY, seqid);
      } else {
