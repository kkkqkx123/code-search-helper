...
@injectable()
export class GraphServiceComposite implements IGraphService {
  ...
  async analyzeDependencies(
    ...
    try {
      ...
      this.errorHandler.handleError(
        ...
        { component: 'GraphServiceComposite', operation: 'analyzeDependencies' }
      );
      throw error;
    }
  }
  ...
  // Space management methods (from GraphPersistenceService)
