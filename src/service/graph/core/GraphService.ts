...
export class GraphService implements IGraphService {
  ...
  async analyzeCodebase(
    ...
    try {
      ...
      return {
        ...
        formattedResult: this.formatForLLM(processedResult),
      };
    } catch (error) {
  ...
  async findRelatedNodes(
    ...
    return this.graphPersistenceService.findRelatedNodes(nodeId, relationshipTypes, maxDepth);
  }
  ...
  async findPath(
    ...
    return this.graphPersistenceService.findPath(sourceId, targetId, maxDepth);
  }
  ...
  async storeParsedFiles(
    ...
    return this.graphPersistenceService.storeParsedFiles(files, options);
  }
  ...
  async storeChunks(
    ...
    return this.graphPersistenceService.storeChunks(chunks, options);
  }

  async deleteNodes(nodeIds: string[]): Promise<boolean> {
    return this.graphPersistenceService.deleteNodes(nodeIds);
  }

  async clearGraph(): Promise<boolean> {
    return this.graphPersistenceService.clearGraph();
  }

  isServiceInitialized(): boolean {
    return this.graphPersistenceService.isServiceInitialized();
  }
