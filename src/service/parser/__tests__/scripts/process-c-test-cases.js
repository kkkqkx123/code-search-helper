...
// 测试用例文件路径
const STRUCT_TEST_CASE_FILE = path.join(__dirname, '../src/service/parser/__tests__/c/structs/c-struct.json');
const CONCURRENCY_TEST_CASE_FILE = path.join(__dirname, '../src/service/parser/__tests__/c/concurrency/c-concurrency.json');

// 输出目录
const STRUCT_OUTPUT_DIR = path.join(__dirname, '../src/service/parser/__tests__/c/structs');
const CONCURRENCY_OUTPUT_DIR = path.join(__dirname, '../src/service/parser/__tests__/c/concurrency');
