...
export class CssLanguageAdapter implements ILanguageAdapter {
  ...
  mapNodeType(nodeType: string): string {
    const typeMapping: Record<string, string> = {
      ...
      'class_selector': 'classDeclaration',
      'id_selector': 'classDeclaration',
      'tag_name': 'classDeclaration',
      'pseudo_class_selector': 'classDeclaration',
      'pseudo_element_selector': 'classDeclaration',
      'attribute_selector': 'classDeclaration',
      'universal_selector': 'classDeclaration',
      'child_selector': 'classDeclaration',
      'sibling_selector': 'classDeclaration',
      'adjacent_sibling_selector': 'classDeclaration',
      'descendant_selector': 'classDeclaration',
      'namespace_selector': 'classDeclaration',
      'nesting_selector': 'classDeclaration',
      'declaration': 'variableDeclaration',
      'property_name': 'variableDeclaration',
      'integer_value': 'variableDeclaration',
      'float_value': 'variableDeclaration',
      'color_value': 'variableDeclaration',
      'string_value': 'variableDeclaration',
      'plain_value': 'variableDeclaration',
      'call_expression': 'callExpression',
      'function_name': 'callExpression',
      'binary_expression': 'variableDeclaration',
      'integer_value_with_unit': 'variableDeclaration',
      'float_value_with_unit': 'variableDeclaration',
      'media_statement': 'functionDeclaration',
      'keyframes_statement': 'functionDeclaration',
      'import_statement': 'importDeclaration',
      'at_rule': 'functionDeclaration',
      'supports_statement': 'functionDeclaration',
      'namespace_statement': 'functionDeclaration',
