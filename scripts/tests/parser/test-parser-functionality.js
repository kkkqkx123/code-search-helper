...
class ParserTestScript {
  constructor() {
    // 延迟加载模块以避免启动时的依赖问题
    this.treeSitterCoreService = null;
    this.treeSitterService = null;
    this.splitter = null;
    this.testResults = {
      total: 0,
      passed: 0,
 ...
 async initializeServices() {
    try {
      const { TreeSitterCoreService } = await import('../../src/service/parser/core/parse/TreeSitterCoreService.js');
      const { TreeSitterService } = await import('../../src/service/parser/core/parse/TreeSitterService.js');
      const { ASTCodeSplitter } = await import('../../src/service/parser/splitting/ASTCodeSplitter.js');
...
module.exports = { ParserTestScript };